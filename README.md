  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <div style="border: 1px solid #e1e4e8; border-radius: 12px; padding: 12px; background: #ffffff;">
        <img src="https://raw.githubusercontent.com/Paraseww/Tailor/main/frontend/images/first4.png" alt="Digital Storefront Showcase" width="100%" style="border-radius: 8px;">
        <br><br>
    ...
    <td width="50%" align="center" valign="top">
      <div style="border: 1px solid #e1e4e8; border-radius: 12px; padding: 12px; background: #ffffff;">
        <img src="https://raw.githubusercontent.com/Paraseww/Tailor/main/frontend/images/last4.png" alt="Retail & Order Tracking Showcase" width="100%" style="border-radius: 8px;">
        <br><br>
